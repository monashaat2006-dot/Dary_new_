    ...
    <header className="dary-header">
      <div className="dary-header-start">
        ...
        <div className="dary-header-greeting">
          <h2>
            {locale === 'ar' ? `مرحبًا بك، ${firstName} 🛡️` : `Welcome, ${firstName} 🛡️`}
          </h2>
          <p>
            {locale === 'ar'
              ? 'لوحة إدارة منصة داري — المراقبة، المستخدمين، العقارات والشكاوى'
              : 'DARY Administration — Operations, users, properties and reports'}
          </p>
        </div>
      </div>
